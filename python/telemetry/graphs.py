...
ax1.legend(linhas1 + linhas2, labels1 + labels2, loc='upper center', bbox_to_anchor=(0.5, 1.15), ncol=3, fontsize=10)
...
for i in range(len(distancias)):
    ...
    ax1.text(distancias[i], rssi_avg[i] + 3, f'{rssi_avg[i]} dBm', 
             color=cor_rssi, fontweight='normal', ha='center', va='bottom', fontsize=9)
...
for i in range(len(distancias)):
    ...
    ax2.text(distancias[i], erro_pct[i] + 0.3, f'{erro_pct[i]}%', 
             color=cor_erro, fontweight='normal', ha='center', va='bottom', fontsize=9)
# ==========================================================
